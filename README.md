...
3_\\Maximum Heart Rate Distribution
Chart Type:Histogram
...
5_\\Cholesterol by Chest Pain Type
Chart Type:Box Plot
Columns Used:
- cp
- chol
...
6_\\Average Heart Rate by Exercise-Induced Angina
Chart Type:Bar Chart
Columns Used:
- exang
- thalach
...
10_\\ Chest Pain Type Distribution
Chart Type:Treemap
 Column Used: cp
Metric:COUNT(*)
